        ...
        <div class="row justify-content-center align-items-center">
          <div class="col-lg-12 banner-right">
            ...
            <p class="mx-auto text-white  mt-20 mb-40">
              Saiba como está o seu andamento ou a nota dos seus cursos
            </p>
          </div>
        </div>
      </div>
    ...
    <section class="popular-course-area section-gap">
      <div class="container-fluid">
        <div class="row justify-content-center section-title">
          <div class="col-lg-12">
            <h2>Minhas turmas <br /></h2>
            <p>
              Seus alunos estão te esperando
            </p>
          </div>
        </div>
            ...
            <%  for(int i = 0; i < ((List<Turmas>) session.getAttribute("turmasInstrutor")).size(); i++){
                    for(int j = 0; j < ((List<Cursos>) session.getAttribute("cursosInstrutor")).size(); j++){
                        if(((List<Turmas>) session.getAttribute("turmasInstrutor")).get(i).getCursos_id() == ((List<Cursos>) session.getAttribute("cursosInstrutor")).get(j).getId()){
                            ...
                            out.println("</div>");
                            out.println("<p> Turma " + ((List<Turmas>) session.getAttribute("turmasInstrutor")).get(i).getId() + " </p>");
                            out.println("<button type=\"button\" class=\"btn btn-primary mt-3\" data-toggle=\"modal\" data-target=\"#nota\">");
                            out.println("Abrir");
                            out.println("</button>");
                            out.println("</div>");
                            out.println("</div>");
        ...
        <div class="modal-content">
          <div class="card">
            <article class="card-body">
              <h4 class="card-title mb-4 mt-1"> Atribuição de notas </h4>
              <form method="POST" action="http://localhost:8080/LeroLero/ProcessaNota">
