        ...
        <div class="row justify-content-center align-items-center">
          <div class="col-lg-12 banner-right">
            ...
            <p class="mx-auto text-white  mt-20 mb-40">
              Conheça um pouco sobre os melhores instrutores da nossa
              plataforma.
            </p>
            <div class="link-nav">
              <span class="box">
                ...
                <a href="http://localhost:8080/LeroLero/VisualizarInstrutores">Instrutores</a>
              </span>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row align-items-center">
          <%    for (int i = 0; i < ((List<Instrutores>) request.getAttribute("listaInstrutores")).size(); i++){
                    ...
                    out.println("</h5>");
                    out.println("<p> Contato: " + ((List<Instrutores>) request.getAttribute("listaInstrutores")).get(i).getEmail() + " </p>");
                    out.println("</h5></div></div></div>");
          }%>
        </div>
      </div>
    </section>
