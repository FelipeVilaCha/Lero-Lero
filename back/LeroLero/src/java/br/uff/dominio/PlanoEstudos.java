...
public class PlanoEstudos {
    ...
    public PlanoEstudos(int id_matricula, String data_matricula, String nome_professor, String nome_curso, int carga_horaria, Float nota, String data_inicio, String data_final) {
